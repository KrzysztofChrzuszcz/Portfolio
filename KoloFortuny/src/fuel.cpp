...
Fuel::Fuel(Engine& engine) :
    ...
    m_Quit(false)
{
    m_Delay = 1000 / SCREEN_REFRESH_FREQUENCY; // TODO: Wziac z konfiguracji m_Settings.m_ScreenRefreshFrequency
}
...
void CustomWorkingThreadNewWay::run()
{
    ...
    // TODO: Zrobic to w stylu C++ 20 i ALE najpierw podbic wersje w CMake!
    /*
