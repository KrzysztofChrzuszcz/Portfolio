...
void WheelOfFortune::hightlightPie() // to powinna byc czesc drawWheel() ktory powinien dostac dodatkowa flage do drawPiePiece // TODO: Przegadac te koncepcje z ChatGPT i CodeRabbit
{
	// TODO
	for (int i = 0; i < m_Positions.size(); i++)
	{
		...
		if (piePosition < m_PieAngle / 2.f || piePosition > 360.f - m_PieAngle / 2.f)
			m_Result = &m_Positions[i].m_LabelName;
		// TODO: w pierwszej wersji dac narysowanie wycinka drugi raz na wierzchu z podswietleniem/wyluszczeniem
